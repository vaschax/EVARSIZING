...
from engines.common import oversize_pct, score_recommendation, status_from_flags
...
def recommend_medtronic(m: Measurements) -> Recommendation:
    ...
    if main_body and contra_limb:
        warnings.append(f"Medtronic: potwierdź w IFU, że połączone komponenty zapewniają minimum {MEDTRONIC_REQUIRED_OVERLAP_MM:.0f} mm zakładki (overlap).")
